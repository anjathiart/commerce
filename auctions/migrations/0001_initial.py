# Generated by Django 3.1 on 2020-09-06 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('bids', models.ManyToManyField(blank=True, related_name='bid', to='auctions.Bid')),
                ...
                ('comments', models.ManyToManyField(blank=True, related_name='comment', to='auctions.Comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='watchListing', to='auctions.listing')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='watchUser', to='auctions.listing')),
            ],
        ),
    ]
